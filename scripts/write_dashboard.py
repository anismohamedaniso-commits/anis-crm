"""Writes the enhanced dashboard_page.dart"""
import os

TARGET = os.path.join(os.path.dirname(__file__), '..', 'lib', 'pages', 'dashboard_page.dart')

CONTENT = r"""import 'package:anis_crm/components/priorities_panel.dart';
...
print(f"Written {TARGET}: {CONTENT.count(chr(10))} lines")
